...
### 📌 Key Concepts
- **Hierarchical Synthesis**: Breaks the design into modules, synthesizing each separately. Ideal for large designs to manage complexity.  
- **Flat Synthesis**: Treats the entire design as a single unit, optimizing globally. Better for smaller designs or critical timing paths.  

| Aspect            | Hierarchical          | Flat                 |
|-------------------|-----------------------|----------------------|
| **Scalability**   | 🟢 High              | 🔴 Low              |
| **Optimization**  | 🟡 Module-level       | 🟢 Global            |
| **Complexity**    | 🟡 Moderate           | 🔴 High             |

> 🧪 **Lab Experiments**: Explore Part 1 (Hierarchical) and Part 2 (Flat) to compare synthesis results.

---

## 🔁 Flop Coding Styles & Optimizations

### 💡 Why Flops?
Flip-flops (flops) are critical for **sequential logic**, storing state and synchronizing signals in clocked designs.

### 🔎 Coding Styles
- **Synchronous Reset**: Reset occurs only on clock edges.  
- **Asynchronous Reset**: Reset occurs immediately, independent of the clock.  
- **Set/Reset Flops**: Support both set and reset functionality.  

### 🧪 Synthesis & Simulation Labs
- **Part 1**: Write Verilog for a D flip-flop with synchronous reset.  
- **Part 2**: Modify for asynchronous reset.  
- **Part 3**: Simulate timing with `.lib` files.  
- **Part 4**: Optimize for power using low-power flops.  
- **Part 5**: Compare synthesis results across coding styles.

> 🚀 **Pro Tip**: Use synthesis attributes to guide tools toward specific flop implementations.

---

<div align="center">
  <em>Happy designing! 🚀 Let’s build faster, smarter chips!</em>
</div>